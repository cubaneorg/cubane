...
import urlbuilder
from cubane.payment.gc.gocardless.utils import generate_signature, to_query, signature_valid
from cubane.payment.gc.gocardless.request import Request
from cubane.payment.gc.gocardless.exceptions import ClientError, SignatureError
from cubane.payment.gc.gocardless.resources import (Merchant, Subscription, Bill,
...
class Client(object):
    ...
    def get_base_url(cls):
        ...
        """
        return cls.base_url or BASE_URLS[cubane.payment.gc.gocardless.environment]
