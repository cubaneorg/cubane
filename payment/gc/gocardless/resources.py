...
from cubane.payment.gc.gocardless.exceptions import ClientError
...
class Resource(object):
    ...
    @classmethod
    def find(cls, id):
        if not cubane.payment.gc.gocardless.client:
            raise ClientError("You must set your account details first")
        return cls.find_with_client(id, cubane.payment.gc.gocardless.client)
